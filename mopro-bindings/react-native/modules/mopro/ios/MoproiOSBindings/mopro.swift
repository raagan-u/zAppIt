...
#if canImport(mopro_bindingsFFI)
...
public func moproUniffiHelloWorld() -> String  {
    ...
    uniffi_mopro_bindings_fn_func_mopro_uniffi_hello_world($0
    )
})
}
...
private let initializationResult: InitializationResult = {
    ...
    if (uniffi_mopro_bindings_checksum_func_mopro_uniffi_hello_world() != 31877) {
