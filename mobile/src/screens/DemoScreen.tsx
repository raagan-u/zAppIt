...
export function DemoScreen() {
  ...
  const handleVote = async (voteType: 'upvote' | 'downvote') => {
    ...
    try {
      ...
      Alert.alert('Success', `${voteType} cast successfully!\nTransaction: ${txHash}`);
    } catch (error) {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Text style={styles.subtitle}>Test the full encryption and proof flow</Text>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.feature}>✓ Nullifier system prevents double actions</Text>
