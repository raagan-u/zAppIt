...
import { storeCircleMembership } from '../utils/encryption';
...
export function JoinCircleScreen() {
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Text style={styles.subtitle}>Enter circle details to join a private community</Text>
      ...
      <View style={styles.quickActions}>
        ...
        <TouchableOpacity style={styles.quickButton} onPress={handlePasteInvite}>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.feature}>✓ Secret is stored securely on your device</Text>
        <Text style={styles.feature}>✓ Zero-knowledge proofs hide your membership</Text>
        <Text style={styles.feature}>✓ All content is encrypted before storage</Text>
      ...
      <View style={styles.helpSection}>
        ...
        <Text style={styles.helpText}>
          ...
          • Use the QR scanner for quick joining{'\n'}
          • Paste invite links from messages or emails{'\n'}
